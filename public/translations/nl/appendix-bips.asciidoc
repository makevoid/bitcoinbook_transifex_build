...
[Bijlage]
== Bitcoin verbetervoorstellen

((("Bitcoin verbetervoorstellen", id = "ix_appdx-bips-asciidoc0", range = "startofrange"))) Bitcoin verbetervoorstellen zijn ontwerp documenten dit geeft informatie aan de bitcoin gemeenschap, of het beschrijven van een nieuwe functie voor bitcoin of haar processen of omgeving. 

Als per BIP0001 _BIP Doel en Guidelines_, zijn er drie soorten van BIP:
