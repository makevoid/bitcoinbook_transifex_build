...
((("bitcoin", id="ix_ch01-asciidoc0", range="startofrange")))((("bitcoin","defined")))Биткойн е колекция от концепции и технологии, които формират основата на дигитална парична екосистема. Валутни единици наречени биткойни се използват за съхраняване и предаване на парична стойност между участници в биткойн мрежата. Биткойн потребители комуникират по между си използвайки биткойн протокола основно чрез Интернет, въпреки че и други транспортни мрежи могат да бъдат използвани. Биткойн протоколът, достъпен като софтуер с отворен код, може да бъде използван на широк обхват от устройства, включително лаптопи и смартфони, което прави технологията леснодостъпна.

Потребители могат да трансферират биткойни през мрежата, правейки почти всичко, което може да се направи с конвенционални валути, включително да купуват и продават продукти и услуги, да изпращат пари на хора или организации, както и да предоставят кредити. Биткойни могат да бъдат закупени, продадени или обменени за други валути в специализирани валутни борси. Биткойн от една страна е перфектната форма на пари за Интернет, защото е бърз, сигурен и без ограничения.
