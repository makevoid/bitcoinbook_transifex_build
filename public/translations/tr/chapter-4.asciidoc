...
Anahtarlar, Adresler ve Cüzdanlar
...
[[k_to_K_to_A]]
Özel anahtar, açık anahtar ve bitcoin adresi
...
===== Rastgele bir sayıdan özel anahtar üretmek
...
Daha fazla bilgi için "help", "copyright", "credits" ya da "license" yazın.
...
Açık anahtar K bir nokta olarak tanımlanır +K = (x,y)+:
...
[[pubkey_to_address]]
Açık anahtardan bitcoin adresine: Bir açık anahtarın bitcoin adresine dönüşümü 
image::images/msbt_0405.png["pubkey_to_address"]

[[base58]]
==== Base58 and Base58Check Kodlaması
...
[[addr_example]]
.Özel bir anahtardan Base58Check ile kodlanmış bitcoin adresi oluşturma
====
[source, cpp]
----
...
[[addr_example_run]]
.Addr kodunu derleme ve çalıştırma
====
[source,bash]
----
...
$ ./addr
Açık anahtar: 0202a406624211f2abbdc68da3df929f938c3399dd79fac1b51b0e4ad1d26a47aa
Adres: 1PRTTaJesdNovgne6Ehcdu1fpEdX7913CK
----
====
...
[[table_4-3]]
.Örnek: Aynı anahtar, farklı biçimler
[options="header"]
|=======
|Format | Özel Anahtar
...
===== Hex'ten Base58Check'e kodlamak
...
| Hex | 1E99423A4ED27608A15A2616A2B0E9E52CED330AC530EDCC32C8FFC6A526AEDD
| WIF | 5J3mBbAH58CpQ3Y5RNJpUKPE62SQ5tfcvU2JpbnkeyhfsYB1Jcn
| Hex-sıkıştırılmış| 1E99423A4ED27608A15A2616A2B0E9E52CED330AC530EDCC32C8FFC6A526AEDD_01_
| WIF-compressed | KxFC1jmwwCoACiCAWZ3eXa96mBM6tb3TYzGmf6YwgdGWZgawvrtJ
|=======
...
Özel Anahtar (decimal) :  
 26563230048437957592232553826663696440606756685920117476832299673293013768870
Özel Anahtar (WIF) :  
 5JG9hT3beGTJuUAmCQEmNaxAuMacCTfXuw1R3FCXig23RQHMr4K
Sıkıştırılmış Özel Anahtar (hex) :  
 3aba4162c7251c891207b747840551a71939b0de081f85c4e44cf7c13e41daa601
Özel Anahtar  (WIF-Sıkıştırılmış) :  
 KyBsPXxTuVD82av65KZkrGrWi5qLMah5SdNq6uftawDbgKa2wv6S
Açık Anahtar (x,y) koordinatları : 
...
Sıkıştırılmış Açık Anahtar (hex) : 
 025c0de3b9c8ab18dd04e3511243ec2952002dbfadc864b9628910169d9b9b00ec
Bitcoin Adres (b58check) : 
 1thMirt546nngXqyPEz532S8fLwbozud8
Sıkıştırılmış Bitcoin Adres (b58check) : 
...
<<ec_math_run>> Bu scripti çalıştırarak üretilen çıktıyı gösterir.(((range="endofrange", startref="ix_ch04-asciidoc22")))(((range="endofrange", startref="ix_ch04-asciidoc21")))(((range="endofrange", startref="ix_ch04-asciidoc20")))(((range="endofrange", startref="ix_ch04-asciidoc19")))(((range="endofrange", startref="ix_ch04-asciidoc18")))
...
[[ec_math_run]]
.Python ECDSA kütüphanesini yükleme ve ec_math.py scriptini çalıştırma
====
----
...
BTC açık anahtar: 029ade3effb0a67d5c8609850d797366af428f4a0d5194cb221d807770a1522873
----
====
