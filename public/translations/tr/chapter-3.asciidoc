...
((("bitcoin client", id="ix_ch03-asciidoc0", range="startofrange")))((("bitcoin client","Bitcoin Core", id="ix_ch03-asciidoc1", range="startofrange")))((("Bitcoin Core client", id="ix_ch03-asciidoc2", range="startofrange")))((("Satoshi client", see="Bitcoin Core client"))) Satoshi istemci olarak da bilinen referans istemciyi _Bitcoin Core_'u bitcoin.org'dan indirebilirsiniz. Referans istemci, cüzdan, tüm işlem kütüğünü içeren bir işlem onay motoru ve kişiden kişiye bitcoin ağına bağlı eksiksiz bir ağ düğümü olmak üzere bitcoin sisteminin bütün parçalarını içerir,

((("bitcoin.org","Bitcoin Core, downloading"))) https://bitcoin.org/tr/cuzdaninizi-secin [Bitcoin Cüzdanınızı Seçin sayfası] Bitcoin Core seçip referans istemciyi indirin. İşletim sisteminize bağlı olarak koşturulabilen bir kurulum indireceksiniz. Windows için, bu ZIP dosyası veya .exe dosyası olabilir. Mac için, bu .dmg uzantılı sürücü imajı. Linux versiyonları Ubuntu için bir PPA paketi veya .tar.gz dosyası içerir. Bitcoin.org sayfası tavsiye edilen bitcoin istemcilerini burada görülebileceği gibi  <<bitcoin-choose-client>> listeler.

[[bitcoin-choose-client]]
Bitcoin.org da bir bitcoin istemcisi seçin
...
Blok zinciri başlatılırken bitcoin çekirdeği ekranı
...
==== Kaynak Koddan Bitcoin Core Derlemek
...
Hataları bildiriniz <info@bitcoin.org>.
...
==== Bitcoin Core İstemci Durumunu Sorgulamak
