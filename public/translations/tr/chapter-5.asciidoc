...
[[tx_bcast]]
==== İşlemleri Bitcoin Ağına Göndermek
...
[[tx_propagation]]
==== İşlemlerin Bitcoin Ağında Yayılması
...
----
Ücretler = Toplam(Girdiler) – Toplam(Çıktılar)
----
...
[[tx_chains]]
=== İşlem Zincirleri ve Öksüz İşlemler
