...
Primero tropeze sobre bitcoin en la mitad de el ano 2011. Mi reaccion immediato fue mas o menos "Si como no! Dinero de bobos!" y lo ignore por unos seis meses, fallando en comprender su importancia. Mi reaccion fue replicado entre varia gente que por mi son de amplio intelligencia, y eso me da consuelo. La segunda vez #IN PROGRESS   
...
**`Ancho constante con negrita`**:: Muestra comandos u otro texto que debe ser tipeado literalmente por el usuario.
...
[WARNING]
====
Este ícono indica una advertencia o cuidado.
====
