...
Brugere kan overføre bitcoin via netværket med henblik på at gøre stort set alt man kan gøre med konventionelle valutaer, inklusivt køb og salg af varer, sende penge til andre mennesker samt organisationer eller udstede kredit. Bitcoin kan købes, sælges og veksles til anden valuta via specialiserede valutabørser. Man kan sige, at bitcoin er den perfekte form for penge til brug på internettet, da bitcoin overføres hurtigt, er sikker og ikke kender nogen landegrænser. 

I modsætning til traditionelle valutaer, er bitcoin fuldt ud virtuel. Der er ingen fysiske bitcoin mønter - endog ingen digitale mønter. Bitcoinbrugere ejer nøgler, der beviser ejerskab af transaktioner på bitcoinnetværket, og således giver de adgang til at spendere eller overføre bitcoin. Disse nøgler er ofte opbevaret i en digital pengepung, der ligger på brugerens computer. Besiddelse af nøglen, der giver adgang til en transaktion, er den eneste forudsætning for at spendere bitcoin. Derved har den individuelle bruger fuld kontrol over sine bitcoin. 
