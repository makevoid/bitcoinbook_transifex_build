...
=== Perche' ci sono degli Insetti sulla Copertina?
...
Alcune edizioni di questo libro sono distribuite sotto licenza open source, come la CC-BY-NC (creativecommons.org), quindi si applicano i termini della suddetta licenza.
...
Si prega di inviare commenti e domande riguardanti questo libro all'editore:
...
Per commenti o per fare domande tecniche riguardo a questo libro, inviare una email a pass:[<email>bookquestions@oreilly.com</email>].

Per ulteriori informazioni sui nostri libri, corsi, conferenze e notizie, vedere il nostro sito web al link:$$http: //www.oreilly.com$$[].

Find us on Facebook: link:$$http://facebook.com/oreilly$$[]

Trovaci su Twitter: link:$$http://twitter.com/oreillymedia$$[]

Guardaci su YouTube: link:$$http://www.youtube.com/oreillymedia$$[]
