...
.Scharmata di Bitcoin Core durante l'inizializzazione della blockchain
...
Non appena l'operazione di git clone sarà completata, avrai una copia locale completa del repository del codice nella directory _bitcoin_. Entra dentro questa directory digitando +cd bitcoin+ nel prompt/terminale:
