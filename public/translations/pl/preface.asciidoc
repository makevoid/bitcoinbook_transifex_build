...
== Pisanie książki o Bitcoinie

Po raz pierwszy natknąłem się na bitcoina w połowie 2011-ego roku. Moją natychmiastową reakcją było mniej więcej "Phi! Pieniądze dla kujownów!" i zignorowałem to na następne sześć miesięcy, zupełnie nie pojmuąc jakie to było ważne. Jest to reakcja, którą widziałem ponownie wśród wielu z najmądrzejrzych znanych mi ludzi i to daje mi pewne pocieszenie. Po raz drugi zetknąłem się z bitcoinem na mailowej liście dyskusyjnej i wtedy zdecydowałem się przeczytać Białą księgę napisaną przez Satoshi'ego Nakamoto, aby przestudiować miarodajne źródło i przkonać się o co w tym wszystkim chodzi. Dalej pamiętam ten moment, kiedy skończyłem lekturę tych dziewięciu stron, chwilę kiedy zdałem sobie sprawę, że bitcoin nie był tylko cyfrową walutą, ale siecią zaufania, która może dać początek tak wielu innym rzeczom niż tylko waluty. Zrozumienie, że: "To nie pieniądze, to rozproszona sieć zaufania", zapoczątkowało czteromiesięczną podróż pożerania każdego skrawka informacji jaki mogłem znaleść na temat bitcoina. Byłem ogarnięty obsesją, spędzając 12 lub więcej godzin przykuty do monitora, czytając, pisząc, kodując, i ucząc się jak najwięcej jak tylko mogłem. Z powodu braku regularnych posiłków wyłoniłem się z tego stanu o 10 kilo lżejszy, pełen determinacji, aby poświęcić się pracy nad bitcoinem. 
