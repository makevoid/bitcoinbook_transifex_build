[[tx_script_ops]]
[appendix]
== Operatori ai limbajului script pentru tranzacții, constante și simbolurilor

((("Script language", id="ix_appdx-scriptops-asciidoc0", range="startofrange")))((("Script language","reserved operator codes", id="ix_appdx-scriptops-asciidoc1", range="startofrange")))<<tx_script_ops_table_pushdata>> arată operatorii pentru împingerea valorilor in stivă((("Script language","push operators")))

[[tx_script_ops_table_pushdata]]
.Push value onto stack
[options="header"]
|=======
| Symbol | Valoare (hex) | Descriere
| OP_0 sau OP_FALSE | 0x00 | Un tablou gol este împins pe stiva
| 1-75 | 0x01-0x4b | Împinge următorii N octeți în stiva, unde N are 1-75 octeți
| OP_PUSHDATA1 | 0x4C | Următorul octet script conține N, împinge următorii N bytes în stivă
| OP_PUSHDATA2 | 0x4d | Următorii doi octeți script conțin N, împinge următorii N bytes în stivă
| OP_PUSHDATA4 | 0x4e | Următorii patru octeți script conțin N, împinge următorii N bytes în stivă
| OP_1NEGATE | 0x4f | Împinge valoarea "-1" în stivă
| OP_RESERVED | 0x50 | Halt - Tranzacție invalidă, cu excepția cazului in care e gasită intr-o clauză OP_IF neexecutată
| OP_1 sau OP_TRUE | 0x51 | Împinge valoarea "1" în stivă
| OP_2 to OP_16 | 0x52 to 0x60 | For OP_N, împinge valoarea "N" în stiva. De exemplu, OP_2 împinge "2"
|=======
