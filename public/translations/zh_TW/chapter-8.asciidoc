...
((("consensus", id="ix_ch08-asciidoc0", range="startofrange")))((("mining", id="ix_ch08-asciidoc1", range="startofrange")))((("miners")))採礦提供新的比特幣供給，同時幫助強化比特幣安全，抵抗不誠實交易或是多次花用同一批比特幣，後者又稱為雙重花費。礦工提供運算資源到比特幣網路來換取得到比特幣報酬的機會。 
