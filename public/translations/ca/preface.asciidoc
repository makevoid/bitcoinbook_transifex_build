...
=== Escrivint el llibre sobre Bitcoin

La primera vegada que vaig ensopegar amb bitcoin va ser a mitjans de 2011. La meva reacció immediata va ser més o menys "Pfft! Diners per setciències!" i ho vaig ignorar durant sis mesos, no en vaig comprendre la seva importància. Aquesta és una reacció que he vist repetidament entre moltes de les persones més intel·ligents que conec, la qual cosa em consola una mica. La segona vegada que em vaig trobar amb bitcoin, en un fòrum de discussió, em vaig decidir a llegir la publicació escrita per Satoshi Nakamoto, per estudiar la font d'informació original i veure de què es tractava tot això. Encara recordo el moment en que vaig acabar de llegir aquelles nou pàgines, quan em vaig adonar que bitcoin no era simplement una moneda digital, sinó una xarxa de confiança que també podria servir de base per a molt més a part de les monedes. La comprensió que "això no és diner, és una xarxa descentralitzada de confiança," em va empènyer a començar un viatge de quatre mesos devorant cada tros d'informació sobre bitcoin que vaig poder trobar. Em vaig obsessionar i estava captivat, invertint 12 o més hores al dia enganxat a una pantalla, llegint, escrivint, programant, i aprenent el màxim que vaig poder. Vaig sortir d'aquest estat d'alienació, 9 quilos més prim per la manca de menjars consistents, decidit a dedicar-me a treballar en bitcoin. 

Dos anys més tard, després de la creació d'una sèrie de petites noves empreses per explorar diversos serveis i productes relacionats amb bitcoin, vaig decidir que ja era hora d'escriure el meu primer llibre. Bitcoin va ser el tema que m'havia conduït a un frenesí de creativitat i consumit els meus pensaments; es tractava de la tecnologia més emocionant que havia vist des d'Internet. Havia arribat el moment de compartir la meva passió per aquesta increïble tecnologia amb un públic més ampli. 

=== Lectors destinataris

Aquest llibre està destinat principalment a programadors. Si saber usar un llenguatge de programació, aquest llibre us ensenyarà com funcionen les monedes digitals, com utilitzar-les, i com desenvolupar programari que les fa servir. Els primers capítols són també adequats com a introducció en profunditat a bitcoin per a no programadors—aquells de vosaltres que volgueu entendre el funcionament intern de bitcoin i les monedes digitals.

=== Per què hi ha cuques a la portada?
...
La natura demostra que els sistemes descentralitzats poden ser resistents i poden generar una complexitat emergent i increïble sofisticació sense necessitat d'una autoritat central, jerarquia, o entitats complexes.
...
=== Convencions utilitzades en aquest llibre
...
[WARNING]
====
Aquesta icona indica un advertiment o precaució.
====
...
=== Com utilitzar els exemples de codi
...
Si us plau envia comentaris i preguntes que tinguis relatives a aquest llibre a l'editorial:
...
Aquest llibre representa els esforços i contribucions de moltes persones. Estic molt agraït per tota l'ajuda que he rebut d'amics, col·legues i fins i tot desconeguts, que s'han unit a mi en aquest esforç per escriure el llibre tècnic definitiu sobre monedes virtuals i bitcoin. 
...
Gràcies a tots per recolzar-me al llarg d'aquest viatge. 
