[[tx_script_ops]]
[appendix]
== Các Toán tử ngôn ngữ kịch bản giao dịch, Hằng số và các Biểu trưng

((("Script language", id="ix_appdx-scriptops-asciidoc0", range="startofrange")))((("Script language","reserved operator codes", id="ix_appdx-scriptops-asciidoc1", range="startofrange")))<<tx_script_ops_table_pushdata>> cung cấp các toán tử giúp đẩy giá trị vào ngăn xếp.((("Script language","push operators")))
