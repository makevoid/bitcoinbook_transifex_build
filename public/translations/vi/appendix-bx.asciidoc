...
== Các câu lệnh của Bitcoin Explorer (bx)

((("Các câu lệnh của Bitcoin Explorer","commands in", id="ix_appdx-bx-asciidoc0", range="startofrange")))

----
Cách sử dụng: bx COMMAND [--help]

Thông tin: Các câu lệnh bx gồm:
...
Để có thêm thông tin, xin đọc https://github.com/libbitcoin/libbitcoin-explorer[Trang chủ Bitcoin Explorer] và https://github.com/libbitcoin/libbitcoin-explorer/wiki[Tài liệu người sử dụng Bitcoin Explorer].

=== Các ví dụ về cách dùng lệnh bx
